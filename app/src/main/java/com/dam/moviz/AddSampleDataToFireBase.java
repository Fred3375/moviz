...
public class AddSampleDataToFireBase extends Application implements Constants {
    ...
    public static CollectionReference filmRef = FirebaseFirestore
            .getInstance()
            .collection(COLLECTION_FILMS);

    public static StorageReference afficheRef = FirebaseStorage
            .getInstance()
            .getReference(DOSSIER_AFFICHES);
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (data != null && data.length == NB_COLONNES) { // On vérifie si data est non null et sa longueur
                    ...
                    Log.i(TAG, "uriToParse : " + uriToParse);
                    i++;
